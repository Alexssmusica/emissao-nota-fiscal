...
export function getTotal(total: TNFeInfNFeTotal): TNFeInfNFeTotal {
  return {
    ICMSTot: {
      ...
      vICMSMono: total.ICMSTot.vICMSMono === undefined ? undefined : Number(total.ICMSTot.vICMSMono).toFixed(2),
      vICMSMonoReten: total.ICMSTot.vICMSMonoReten === undefined ? undefined : Number(total.ICMSTot.vICMSMonoReten).toFixed(2),
      vICMSMonoRet: total.ICMSTot.vICMSMonoRet === undefined ? undefined : Number(total.ICMSTot.vICMSMonoRet).toFixed(2),
