import { SoapAbstract } from '../../application/abstract/soap-info';
import autorizadores from '../../application/helpers/urls/autorizadores.json';
import type { InfoQRCodeByUF } from '../../domain/contracts/repos';

export class SefazNFCe extends SoapAbstract {
      ...
      switch (uf) {
        ...
        case 'BA':
          return {
            ...
            urlQRCode: 'http://nfe.sefaz.ba.gov.br/servicos/nfce/modulos/geral/NFCEC_consulta_chave_acesso.aspx'
          };
        case 'CE':
        ...
        case 'MG':
          return {
            ...
            urlQRCode: 'https://nfce.fazenda.mg.gov.br/portalnfce/sistema/qrcode.xhtml'
          };
        case 'MS':
        ...
        case 'PA':
          return {
            ...
            urlQRCode: 'https://appnfc.sefa.pa.gov.br/portal/view/consultas/nfce/nfceForm.seam'
          };
        case 'PB':
      ...
      switch (uf) {
        ...
        case 'BA':
          return {
            ...
            urlQRCode: 'http://hnfe.sefaz.ba.gov.br/servicos/nfce/modulos/geral/NFCEC_consulta_chave_acesso.aspx'
          };
        case 'CE':
        ...
        case 'GO':
          return {
            ...
            urlQRCode: 'http://homolog.sefaz.go.gov.br/nfeweb/sites/nfce/danfeNFCe'
          };
        case 'MA':
          return {
        ...
        case 'MT':
          return {
            ...
            urlQRCode: 'http://homologacao.sefaz.mt.gov.br/nfce/consultanfce'
          };
        case 'PA':
          return {
            urlChave: 'www.sefa.pa.gov.br/nfce/consulta',
            urlQRCode: 'https://appnfc.sefa.pa.gov.br/portal-homologacao/view/consultas/nfce/nfceForm.seam'
          };
        case 'PB':
        ...
        case 'TO':
          return {
            ...
            urlQRCode: 'http://homologacao.sefaz.to.gov.br/nfce/qrcode'
          };
        default:
          throw new Error('URL do QRCode não encontrada pelo UF (' + uf + ') informado.');
      }
