...
import type { Configuracoes, SoapRequest } from '../../../domain/contracts/repos';
  ...
  try {
    ...
    do {
      ...
      retornoConsulta = await gerarRetornoEmissao({
        ...
        success:
          responseProtocolo.data.retConsReciNFe.cStat === '104' && responseProtocolo.data.retConsReciNFe.protNFe.infProt.cStat === '100',
